...
export default function MediaOrganizePage() {
  ...
  // Save current group
  const saveGroup = () => {
    if (!currentGroup || !currentGroup.brand || !currentGroup.projectName) {
  ...
  const exportJSON = () => {
    ...
    // Group projects by service, or put in "Specials" if no service selected
    ...
    <div className="min-h-screen bg-gray-50 pt-20 pb-10">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="mb-8">
          ...
          <p className="text-dark-600" style={{ fontFamily: "var(--font-outfit), sans-serif" }}>
            ...
            {currentGroup && (
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2
                  ...
                  style={{ fontFamily: "var(--font-space-grotesk), sans-serif" }}
                >
                  Configure Group ({currentGroup.files?.length || 0} files)
                </h2>
